...
const (
	POST_INDEX = "post" //name of database like mySQL
	POST_TYPE  = "post" //name of table like table of mySQL

	DISTANCE = "200km"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL = "http://35.243.186.38:9200"
...
//equal to schema in mySQL, support k-d tree for fast search
//geo_point is a unique data structure

// _ is a char that is declared but not usred
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	ctx := context.Background() //for Go routine
